...
namespace SzParag.Controllers
{
    public class ProducersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Address,PostalCode,City")] Producer producer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Address,PostalCode,City")] Producer producer)
        {
            if (id != producer.Id)
            {
                return NotFound();
